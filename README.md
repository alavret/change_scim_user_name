...
> [!NOTE]
> SCIM OAuth токен и Domain ID проще всего взять из параметров конфигурации утилиты SCIM для синхронизации пользователей локальной AD в Яндекс 360. 
...
3. **Настройте окружение**:
   ...
   - Убедитесь, что у вас есть действующий SCIM OAuth-токен и ID домена Yandex 360.
